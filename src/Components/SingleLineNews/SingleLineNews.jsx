...
const SingleLineNews = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      setLoading(true);
      const response = await axios.get(`https://linesnews.onrender.com/api/one-lines?pagination[page]=${page}&pagination[pageSize]=10&sort=publishedAt:desc`);
